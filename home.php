...
<body>
  ...
  <a href="hisroom.php" class="sidebar-link">ประวัติการจองของฉัน</a>
  <a href="rooms.php" class="sidebar-link">จองห้องประชุม</a>
  <a href="check_status.php" class="sidebar-link">ตรวจสอบสถานะการจอง</a>
  <a href="logout.php" class="sidebar-link">ออกจากระบบ</a>

  <!-- แถบการติดต่อ -->
  <div class="contact-box">
    <h3>ติดต่อโรงแรม</h3>
    <p><strong>โทร:</strong> 043-123456</p>
    <p><strong>อีเมล:</strong> contact@khonkaenhotel.com</p>
  </div>
</div>
